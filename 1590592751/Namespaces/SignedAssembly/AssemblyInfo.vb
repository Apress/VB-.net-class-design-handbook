...
' Change these attribute values to modify the 
...
' is exposed to COM
<Assembly: Guid("D887D39A-47B2-41A4-A849-6B04C4804B11")> 
...
' the Build and Revision Numbers by using the '*' 
' as shown below:
<Assembly: AssemblyVersion("1.0.0.0")> 
<Assembly: AssemblyKeyFile("C:\CodeOrganization\MyKeyFolder\MyKey.snk")> 
