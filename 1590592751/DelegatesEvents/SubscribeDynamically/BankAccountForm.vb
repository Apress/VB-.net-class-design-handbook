...
Public Class BankAccountForm
    ...
    ' Every BankAccountForm is associated with a BankAccount 
    Private mTheAccount As BankAccount

    ' Property to set the BankAccount for this form
    Public WriteOnly Property Account() As BankAccount
        Set(ByVal Value As BankAccount)
            mTheAccount = Value
            Text = mTheAccount.ToString() & _
            ", balance: " & mTheAccount.Balance
        End Set
    End Property
